  ...
  <CButton color="info" onClick={() => setInfo(!info)} className="mr-1">Info modal</CButton>*/}
            ...
            >
              <CModalHeader closeButton>
                <CModalTitle>Administration | Training Institution Setup</CModalTitle>
              </CModalHeader>
              <CModalBody>
      <form>
      <CRow>         
      <CCol xs="12" md="12">
          <CCard>
            <CCardHeader>INSTITUTION MANAGEMENT</CCardHeader>
            <CCardBody>
              <CForm action="" method="post" className="form-horizontal">
                <CFormGroup row>
                  <CCol md="12">
                    <CInputGroup>
                      <CInputGroupPrepend>
                        <CButton type="InsName" color="primary"><CIcon name="cil-magnifying-glass" /></CButton>
                      </CInputGroupPrepend>
                      <CInput id="InsName" name="InsName" placeholder="Institution Name" />
                    </CInputGroup>
                  </CCol>
                </CFormGroup>
