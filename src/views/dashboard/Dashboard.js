...
const Dashboard = () => {
  ...
  const [loanArrears, setLoanArrears] = useState([])
  const [defaulters, setDefaulters] = useState([])
  useEffect(() => {
    async function getExpectedPayments() {
      const results = await axios.get(apiUrl + '/loanreports/expectedPayments')
      setExpectedPayments(results.data)
    }
    getExpectedPayments()
  ...
  //     const results = await axios.get(apiUrl + '/loanreports/loanarrears')
  //     setLoanArrears(results.data)
  //   }
  //   getLoanArrears()
  //   console.log(loanArrears)
  // }, [render])
          ...
          <CRow>
            <CCol sm="5">
              <h4 id="traffic" className="card-title mb-0">
                DARA CAPITAL CONSULT ANALYTICS
              </h4>
              <div className="small text-muted">PER DEPARTMENT RATIO</div>
            </CCol>
        ...
        {/* <CCardFooter>
          <CRow className="text-center">
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">Dept</div>
              ...
              <CRow>
                <CCol xs="12" md="6" xl="6">
                  {/* <CRow>
                    <CCol sm="6">
                      <CCallout color="info">
                        <small className="text-muted">PSM LINK</small>
                        <br />
                        <strong className="h4">MENU</strong>
                      </CCallout>
                    </CCol>
                    <CCol sm="6">
                ...
                {/* <CCardBody>
          <Table className="table-sm" hover striped bordered>
            ...
            <tbody>
              {allstaff.map((c, index) => (
                ...
                <CRow>
                  <CCol>
                    <CCard>
                      <CCardHeader>Defaulters</CCardHeader>
                      <CCardBody>
                        <CDataTable
                          items={defaulters}
                          fields={fields}
                ...
                <CCol xs="12" md="6" xl="6">
                  ...
                  {/* <div className="progress-group">
                    <div className="progress-group-header">
                      <CIcon name="#" className="progress-group-icon" />
              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  {expectedPayments.map((c, index) => (
                    <tr key={c.id}>
                      <td>{index + 1}</td>
                      <td className="text-left">
                        {c.Customer}
                        <div className="small text-muted">
                          <span>{c.Officer}</span> | Date Booked: {c.bookedDate}
                        </div>
                        <span className="c-avatar-status bg-success"></span>
                      </td>
                      <td className="text-center">{c.accountNumber}</td>
                      <td className="text-center">{c.loanId}</td>
                      <td className="text-center">
                        {formatter.format(c.loanAmount)}
                      </td>
                      <td className="text-center">
                        {formatter.format(c.paymentsMade)}
                      </td>
                      <td className="text-center">
                        {formatter.format(c.PaymentDue)}
                      </td>
                    </tr>
                  ))}
              ...
              <br />
              <span>
                <h4>Loans In Arrears</h4>
              </span>
              <table className="mt-3 table table-hover table-outline mb-0 d-none d-sm-table">
                <thead className="thead-light">
                  <tr>
                    <th className="text-center">
                      <CIcon name="cil-people" />
                    ...
                    <th className="text-center">Arrears</th>
                  </tr>
                </thead>
                <tbody>
                  {loanArrears.map((c, index) => (
                    <tr key={c.id}>
                      <td>{index + 1}</td>
                      <td className="text-left">
                        {c.customer}
                        <div className="small text-muted">
                          <span>{c.staff}</span> | Customer Phone: {c.phone}
                        </div>
                        <span className="c-avatar-status bg-success"></span>
                      </td>
                      <td className="text-center">{c.idNumber}</td>
                      <td className="text-center">{formatter.format(c.due)}</td>
                      <td className="text-center">
                        {formatter.format(c.paid)}
                      </td>
                      <td className="text-center">
                        {formatter.format(c.Arrears)}
                      </td>
                    </tr>
                  ))}
              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  {defaulters.map((c, index) => (
                    <tr key={c.id}>
                      <td>{index + 1}</td>
                      <td className="text-left">
                        {c.fullName}
                        <div className="small text-muted">
                          <span>{c.Officer}</span> | Customer Phone: {c.phone}
                        </div>
                        <span className="c-avatar-status bg-success"></span>
                      </td>
                      <td className="text-center">{c.accountNumber}</td>
